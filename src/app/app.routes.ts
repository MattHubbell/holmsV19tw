...
export const routes: Routes = [
  ...
  { path: 'new-registrations', component: NewRegistrationComponent, canActivate: [AuthGuard] },
  { path: 'setup', component: SetupComponent },
  { path: 'protected-content', component: ProtectedContentComponent, canActivate: [AuthGuard] },
  { path: '**', redirectTo: '' }
];
